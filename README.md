...
- **Computer Vision Model** [code]([https://github.com/Luanjie-Dong/CrowdSight/tree/main/crowdsight](https://github.com/Luanjie-Dong/CrowdSight/tree/main/backend/model))
